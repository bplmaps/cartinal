...
<template>
   <table v-if="this.considerations.systemicInjustice" id ="property-table">
     <p class="larger-text">{{this.considerations.systemicInjustice.description}}</p>
  <tr>
    <th>Property</th>
    <th>Expected Type</th>
    <th>Required</th>
  ...
  <tr v-for="item, index in this.considerations.systemicInjustice.properties" :key="index">
    <td><a :href="index + '.html'" >{{index}}</a></td>
    <td>{{item.type}}</td>
    <td id="required">{{checkRequired(index, schema.considerations.properties.systemicInjustice.properties.required)}}</td>
