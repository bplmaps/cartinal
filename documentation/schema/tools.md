...
<template>
   <table v-if="this.lifecycle.processing" id ="property-table">
     <p class="larger-text">{{this.lifecycle.processing.properties.tools.description}}</p>
  <tr>
    <th>Property</th>
    <th>Expected Type</th>
    <th>Required</th>
  ...
  <tr v-for="item, index in this.lifecycle.processing.properties.tools.items[0].properties" :key="index">
