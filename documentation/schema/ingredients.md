...
<template>
   <table v-if="this.lifecycle.acquisition" id ="property-table">
     <p class="larger-text">{{this.lifecycle.acquisition.properties.ingredients.description}}</p>
  <tr>
    <th>Property</th>
    <th>Expected Type</th>
    <th>Required</th>
  ...
  <tr v-for="item, index in this.lifecycle.acquisition.properties.ingredients.items[0].properties" :key="index">
