...
<template>
   <table v-if="this.peopleLifecycle.processing" id ="property-table">
     <p class="larger-text">{{this.peopleLifecycle.processing.properties.choices.description}}</p>
  <tr>
    <th>Property</th>
    <th>Expected Type</th>
    <th>Required</th>
  ...
  <tr v-for="item, index in this.peopleLifecycle.processing.properties.choices.items[0].properties" :key="index">
