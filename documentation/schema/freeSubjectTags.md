...
<template>
    ...
    <table id ="property-table">
        ...
        <tr v-for="item, index in this.subjectTagging.thematic.properties.freeSubjectTags.items[0].properties" :key="index">
            <td>{{index}}</td>
            <td>{{item.type}}</td>
            <td id="required">{{checkRequired(index, schema.subjectTagging.properties.thematic.properties.freeSubjectTags.items[0].required)}}</td>
